# Generated by Django 2.1.7 on 2019-10-08 00:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('situacao', models.CharField(choices=[('Abster', 'Abster'), ('Reprovar', 'Reprovar'), ('Aprovar', 'Aprovar')], default='Abster', max_length=8)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='votacoes.OfertaDisciplina'),
        ),
        migrations.AddField(
